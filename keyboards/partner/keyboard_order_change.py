...
def keyboard_edit() -> InlineKeyboardMarkup:
    """
    ...
    button_1 = InlineKeyboardButton(text='Плательщик',
                                    callback_data='reqchangeorder_payer')
    button_2 = InlineKeyboardButton(text='ИНН',
                                    callback_data='reqchangeorder_inn')
    button_3 = InlineKeyboardButton(text='Подтвердить',
                                    callback_data='reqchangeorder_confirm')
